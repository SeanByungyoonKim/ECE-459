...
std::string IdeaGenerator::getNextIdea(Container<std::string> products, Container<std::string> customers, int i) {
...
void IdeaGenerator::run() {
    ...
    for (int i = ideaStartIdx; i <= ideaEndIdx; i++) {
        std::string ideaName = getNextIdea(products, customers, i);
